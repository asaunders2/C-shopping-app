$(function () {
    ...
    */
    ...
    $(".selectAll").change(function () {
        ...
        $('#balloonTable').find(':checkbox').each(function () {
    ...
    */
    ...
    $(".selectAll").change(function () {
        var checkedStatus = this.checked;
        $('#balloonTable tbody').find(':checkbox').each(function () {
            $(this).prop('checked', checkedStatus);
        });
    });
    */
    ...
    $(".selectAll").change(function () {
        var checkedStatus = this.checked;
        $('.bx').find(':checkbox').each(function () {
            $(this).prop('checked', checkedStatus);
        });
    });
    */
    ...
    $(".selectAll").change(function () {
        var checkedStatus = this.checked;
        $('#balloonTable tbody tr').find(':checkbox').each(function () {
            $(this).prop('checked', checkedStatus);
        });
    });
    */
    ...
    */
    ...
    /*
    $("#selectAllBalloons").click(function () {
        var checkedStatus = this.checked;
        $('#balloonTable tbody tr').find(':checkbox').each(function () {
            $(this).prop('checked', checkedStatus);
        });
